...
import com.mygh.common.rabbit.constant.MqConst;
import com.mygh.common.rabbit.service.RabbitService;
import com.mygh.common.result.ResultCodeEnum;
import com.mygh.enums.OrderStatusEnum;
import com.mygh.hosp.client.HospitalFeignClient;
import com.mygh.model.order.OrderInfo;
import com.mygh.model.user.Patient;
import com.mygh.order.mapper.OrderMapper;
import com.mygh.order.service.OrderService;
import com.mygh.order.service.WeixinService;
import com.mygh.user.client.PatientFeignClient;
import com.mygh.vo.hosp.ScheduleOrderVo;
import com.mygh.vo.msm.MsmVo;
import com.mygh.vo.order.*;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if(new DateTime(scheduleOrderVo.getStartTime()).isAfterNow()
            ...
            throw new MyghException(ResultCodeEnum.TIME_NO);
        }
        ...
        if (result.getInteger("code")==200){
            ...
            throw new MyghException(result.getString("message"), ResultCodeEnum.FAIL.getCode());
        }
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        if(quitTime.isBeforeNow()){
            throw new MyghException(ResultCodeEnum.CANCEL_ORDER_NO);
        }
        //调用医院接口实现预约取消
        ...
        if(result.getInteger("code")!=200) {
            ...
            if(orderInfo.getOrderStatus().intValue() == OrderStatusEnum.PAID.getStatus().intValue()) {
                ...
                if(!isRefund) {
                    throw new MyghException(ResultCodeEnum.CANCEL_ORDER_FAIL);
                }
                //更新订单状态
